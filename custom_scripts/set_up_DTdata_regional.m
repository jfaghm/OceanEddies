function set_up_DTdata_regional(NetCDF_files_path, ssh_NetCDF_name, lat_NetCDF_name, lon_NetCDF_name, lonlimit, latlimit, ssh_save_path)

% Modified @ 4 April 2018 - Area map function 
%                @ 3 May 2018 - Directory in Directory for input data
%                @ 3 May 2018 - added DT in the name
%                @ 3 May 2018 - accounted new AVISO filename format
% Inputs:
...
disp('Successfully preprocessed')
end
